...
const (
	...
	CategoryAddFailCode int    = -400356
	CategoryAddFailMsg  string = "添加电影类型失败, 分类名称已存在!"

	MovieAddFailCode int    = -400357
	MovieAddFailMsg  string = "添加电影失败, 名称已存在!"

	MovieCommentAddFailCode int    = -400358
	MovieCommentAddFailMsg  string = "添加电影评论失败, 电影ID不存在!"
)
