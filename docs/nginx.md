...
server{
    ...
    root            /home/wwwroot/goproject2020/go-movie/public ;
...
server{
    ...
    // 这里的 @go-movie 和 try_files 语法块的名称必须一致 
    location   @go-movie {
